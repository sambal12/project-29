...
function setup() {
  ...
  //level three
  block27= new Block(675,95,30,40)
  block28= new Block(703,95,30,40)

  //top
  block29 = new Block(690,55,30,40)

  launcher = new SlingShot(this.hexagon,{x:100,y:170})
...
imageMode (CENTER)
image(polygon_img,hexagon.position.x,hexagon.position.y,40,40)
